...
class MasterDataLoader
{
    ...
    private function scanModuleMasterDataDirectories(): array
    {
        ...
        // Scan both bundle src directory and application src directory
        ...
        foreach ($srcDirectories as $srcDir) {
            ...
            foreach ($directories as $dir) {
                if ($dir === '.' || $dir === '..' || $dir === 'Kernel.php' || $dir === 'ProjectTemplateBundle.php' || $dir === 'DependencyInjection') {
                    continue;
                }
                ...
                if (is_dir($masterDataDir)) {
                    // Use a unique key to avoid conflicts between bundle and app modules
