...
class AuthService
{
    public function __construct(
        ...
        private readonly AuthMailSenderInterface $authMailSender,
    ...
    public function register(string $email, string $password, string $firstName, string $lastName): ?array
    {
        ...
        $this->authMailSender->sendWelcome($user);
    ...
    public function forgotPassword(string $email): ?string
    {
        ...
        $this->authMailSender->sendPasswordReset($user, $resetToken);
    ...
    public function resetPassword(string $token, string $newPassword): bool
    {
        ...
        if ($success && $user) {
            $this->authMailSender->sendPasswordResetConfirmation($user);
        }
