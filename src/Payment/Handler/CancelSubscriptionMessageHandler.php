...
#[AsMessageHandler]
/**
 * @deprecated Handler for the unused CancelSubscriptionMessage. See that class for details.
 */
class CancelSubscriptionMessageHandler implements AsyncMessageHandlerInterface
{
    ...
    public function __invoke(CancelSubscriptionMessage $message): void
    {
        ...
        $this->paymentService->cancelSubscription(
            ...
            immediate: $message->isImmediate(),
            reason: $message->getReason(),
            allowOneMoreCharge: $message->isAllowOneMoreCharge(),
        );
    }
}
